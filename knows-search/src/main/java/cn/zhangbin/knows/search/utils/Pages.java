package cn.zhangbin.knows.search.utils;
...
public class Pages {
    /**
     * 将Spring-Data提供的范爷数据转换为PageHelper范爷数据对象
     * @param page Spring-Data提供的范爷数据
     * @return PageInfo
     */
    public static <T> PageInfo<T> pageInfo(Page<T> page){
        //当前页号从1开始,Spring-Data从0开始,所以要加一
