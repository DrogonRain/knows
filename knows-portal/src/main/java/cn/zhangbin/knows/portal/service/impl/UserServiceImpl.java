...
import cn.zhangbin.knows.portal.mapper.UserRoleMapper;
...
import cn.zhangbin.knows.portal.model.UserRole;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public UserVo getCurrentUserVo(String username) {
        ...
        Integer collections = userCollectService.countCollectionsByUserId(userVo.getId());
        Integer answers = answerService.countAnswersByUserId(userVo.getId());
