...
import cn.zhangbin.knows.portal.mapper.QuestionTagMapper;
import cn.zhangbin.knows.portal.mapper.UserMapper;
import cn.zhangbin.knows.portal.mapper.UserQuestionMapper;
import cn.zhangbin.knows.portal.model.*;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements IQuestionService {
    ...
    public QuestionVo getQuestionVoById(Integer id) {
        ...
        for (int i = 0; i < userQuestions.size(); i++) {
            User user = userMapper.findUserById(userQuestions.get(i).getUserId());
            if (user.getType()==1){
