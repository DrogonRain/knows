package cn.zhangbin.knows.generator;
...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/konws?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="721620";
    //父级别包名称
    public static String parentPackage = "cn.zhangbin.knows";
    //代码生成的目标路径
    ...
    //作者名
    public static String author = "zhangbin.cn";
    //模块名称，用于组成包名
